export default {
  title: "Tickets/task-ESE-0016/task-ESE-0016-01 Install Storybook and configure for the project/Demo",
};
...
export const Demo = {
  render: () => {
    ...
    el.textContent = "Demo not yet implemented for: task-ESE-0016-01";
    return el;
  },
};
