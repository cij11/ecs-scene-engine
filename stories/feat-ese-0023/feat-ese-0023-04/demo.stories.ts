...
export const Demo = {
  render: () => {
    ...
    setTimeout(() => {
      ...
      const SETTLE_DURATION = 10_000; // 10 seconds after growth stops
      ...
      function tick() {
        ...
        // --- Render: top-down Canvas2D (X-Z plane) ---
        ctx.fillStyle = "#111";
        ctx.fillRect(0, 0, 600, 600);

        // Map world coords [-15, 15] to canvas [0, 600]
        const scale = 600 / 30;
        const offsetX = 300;
        const offsetZ = 300;
