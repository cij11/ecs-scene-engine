export default {
  title: "Tickets/task-ESE-0016/task-ESE-0016-02 Create story directory structure and ticket renderer/Demo",
};
...
export const Demo = {
  render: () => {
    ...
    el.textContent = "Demo not yet implemented for: task-ESE-0016-02";
    return el;
  },
};
