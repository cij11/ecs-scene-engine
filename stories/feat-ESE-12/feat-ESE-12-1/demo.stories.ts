export default {
  title: "Tickets/feat-ESE-0012/feat-ESE-0012-01 Architecture document: GPU compute system design/Demo",
};
...
export const Demo = {
  render: () => {
    ...
    el.textContent = "Demo not yet implemented for: feat-ESE-0012-01";
    return el;
  },
};
