export default {
  title: "Tickets/feat-ESE-0012/feat-ESE-0012-02 GpuContext: WebGPU device init and buffer pool/Demo",
};
...
export const Demo = {
  render: () => {
    ...
    el.textContent = "Demo not yet implemented for: feat-ESE-0012-02";
    return el;
  },
};
