export default {
  title: "Tickets/feat-ESE-0012/feat-ESE-0012-04 Buffer sync: upload, dispatch, readback lifecycle/Demo",
};
...
export const Demo = {
  render: () => {
    ...
    el.textContent = "Demo not yet implemented for: feat-ESE-0012-04";
    return el;
  },
};
