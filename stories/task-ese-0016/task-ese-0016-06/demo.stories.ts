export default {
  title: "Tickets/task-ESE-0016/task-ESE-0016-06 Demo: Hello World ticket through full lifecycle/Demo",
};
...
export const Demo = {
  render: () => {
    ...
    el.textContent = "Demo not yet implemented for: task-ESE-0016-06";
    return el;
  },
};
