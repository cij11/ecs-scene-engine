export default {
  title: "Tickets/feat-ESE-0012/feat-ESE-0012-03 WGSL codegen from kernel DSL definitions/Demo",
};
...
export const Demo = {
  render: () => {
    ...
    el.textContent = "Demo not yet implemented for: feat-ESE-0012-03";
    return el;
  },
};
