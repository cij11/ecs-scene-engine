export default {
  title: "Tickets/feat-ESE-0012/feat-ESE-0012-05 Particle system PoC: 10k GPU-driven particles/Demo",
};
...
export const Demo = {
  render: () => {
    ...
    el.textContent = "Demo not yet implemented for: feat-ESE-0012-05";
    return el;
  },
};
