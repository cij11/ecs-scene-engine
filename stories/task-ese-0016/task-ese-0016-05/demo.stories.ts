export default {
  title: "Tickets/task-ESE-0016/task-ESE-0016-05 Migrate existing tickets to story directories/Demo",
};
...
export const Demo = {
  render: () => {
    ...
    el.textContent = "Demo not yet implemented for: task-ESE-0016-05";
    return el;
  },
};
